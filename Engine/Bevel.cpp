...
Bevel::Bevel(Color baseColor)
{
	setBaseColor(baseColor); 
}

void Bevel::DrawOuterBevel(const Rectf& rect, int size, Graphics& gfx) const
{
...
void Bevel::DrawInnerBevel(const Rectf& rect, int size, Graphics & gfx) const
{
	const int left = int(rect.left);
	const int right = int(rect.right);
	const int top = int(rect.top);
...
void Bevel::DrawBeveledBrick(const Rectf& rect, int bevelSize, Graphics & gfx) const
{
	DrawOuterBevel(rect, bevelSize, gfx);
	gfx.DrawRect(rect.GetExpanded(-float(bevelSize)), baseColor);
}

void Bevel::DrawBeveledFrame(const Rectf& rect, int bevelSize, Graphics & gfx) const
{
	DrawOuterBevel(rect, bevelSize, gfx);
	DrawInnerBevel(rect.GetExpanded(-float(bevelSize)), bevelSize, gfx);
}

Color Bevel::GetBaseColor() const
{
	return baseColor;
}

void Bevel::setBaseColor(Color base_in)
{
	baseColor = base_in;
	topColor = Color(
